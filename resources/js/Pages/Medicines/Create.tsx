                ...
                <div className="sticky top-0 z-10 flex items-center justify-between gap-4 border-b bg-white/80 px-6 py-4 backdrop-blur-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-xl font-bold tracking-tight text-slate-900">Tambah Obat Baru</h1>
                            <p className="text-xs text-slate-500">Masukkan detail obat ke dalam inventaris rumah sakit.</p>
                        </div>
                    </div>
                                        ...
                                        >
                                            {imagePreview ? (
                                                ...
                                                <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center px-4">
                                                    ...
                                                    <p className="mb-1 text-sm text-slate-600 font-medium">Klik untuk upload gambar</p>
                                                    <p className="text-xs text-slate-400">Format: JPG, PNG, WEBP (Max 4MB)</p>
                                                </div>
                                            )}
                                            <Input
                                                id="image"
