...
import { PlusCircle, Search, Hospital } from 'lucide-react'
import { DoctorTable } from '@/components/tables/DoctorTable'
import { PaginatedResponse, Doctor } from '@/types'
...
export default function DoctorIndex() {
    const { doctors, filters } = usePage<PageProps>().props
            ...
            <div className="p-6 space-y-6 bg-slate-50/50 min-h-[calc(100vh-4rem)]">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-500">
                            Kelola data dokter spesialis di RS Bhayangkara.
                        </p>
                    </div>
                ...
                <Card className="border border-slate-200 shadow-none overflow-hidden bg-white">
                    ...
                    <CardContent className="px-6">
                        <DoctorTable doctors={doctors} q={q} />
                    </CardContent>
                </Card>
            </div>
        </AdminLayout>
